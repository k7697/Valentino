...
if (isset($_REQUEST['submit'])) {
    ...
    $insert = "insert into staff(staff_name,s_contact_no,address) values('$txt_name','$txt_phone','$txt_address')";
...
if (isset($_REQUEST['btn_update'])) {
    ...
    $update = "update staff set staff_name='$name',s_contact_no='$contact',address='$address' where staff_id='$sid'";
                    ...
                    <tbody>
                        <tr>
                            ...
                            while ($row = mysqli_fetch_array($res)) {
                                ...
                                <td>
                                    <a href="#editEmployeeModal<?php echo $j; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="staff.php?staff_id=<?php echo $row["staff_id"] ?>" onclick="return confirm('Press a button!')" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr> 
                            <?php
                            $j = $j + 1;
        ...
        <div class="modal-content">
            <form>
                <div class="modal-header">						
                    ...
                    <a href="staff.php?staff_id=<?php echo $ro['id'] ?>"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></a>
                </div>
                <div class="modal-body">					
                ...
                <div class="modal-footer">
                    ...
                    ?>
                    <input type="button" class="btn btn-default"   data-dismiss="modal" value="Cancel">
                    <a href="staff.php?staff_id=<?php echo $id ?>"><input type="button"  class="btn btn-danger" value="Delete"></a>
                </div>
            </form>
        </div>
    </div>
