                        ...
                        <div class="col-md-4">
                            <div class="box box-solid">
                                <div class="box-body">
                                    ...
                                    <div class="form-group has-feedback">
                                        Table ID : <input type="text" value="<?php echo $tabl_id ?>" readonly="true" name="tableid" class="form-control" placeholder="tid">
                                    </div>
                                    Add Item :
                                    ...
                                    <div id="<?php echo $row['cat_name']; ?>" class="tab-pane fade <?php echo ($cnt == 0 ) ? 'in active' : ''; ?>">
                                        ...
                                        while ($product_data = mysqli_fetch_assoc($product)) {
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="form-group has-feedback">
                                                        <input type="hidden" readonly="true" name="item_id" value="<?php echo $product_data['item_id'] ?>" class="form-control" placeholder="Number">
                                                    </div>
                                                </div>
                                                <?php
                                            }
